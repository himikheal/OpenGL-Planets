...
void Camera::Matrix(float FOVdeg, float nearPlane, float farPlane, Shader& shader, const char* uniform, glm::mat4 model)
{
...
void Camera::changeOrientation(glm::vec3 orientation) {
	Orientation = orientation;
}
